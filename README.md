...
## ESP Home upgrade to Base64 codes 
By using the provided version of the yaml ESPHome example and the C++ inline lambda include function you will be able to use all the broadlink Base64 and raw codes with an ESPHome made device.
